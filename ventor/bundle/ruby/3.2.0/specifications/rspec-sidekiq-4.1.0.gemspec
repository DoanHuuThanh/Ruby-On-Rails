# -*- encoding: utf-8 -*-
# stub: rspec-sidekiq 4.1.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<rspec-mocks>.freeze, ["~> 3.0".freeze])
  s.add_runtime_dependency(%q<rspec-expectations>.freeze, ["~> 3.0".freeze])
  s.add_runtime_dependency(%q<sidekiq>.freeze, [">= 5".freeze, "< 8".freeze])
  ...
  s.add_development_dependency(%q<actionmailer>.freeze, [">= 0".freeze])
